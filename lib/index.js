(function() {
  ...
  typecast = function(p_array, p_type) {
  ...
  TypedArray = (function(_super) {
    ...
    function TypedArray(p_type, p_array) {
    ...
    TypedArray.prototype.push = function() {
      var args;
      args = typecast(arguments, this.type);
    ...
    TypedArray.prototype.splice = function() {
      ...
      return TypedArray.__super__.splice.apply(this, args.slice(0, 2).concat(typecast(args.slice(2), this.type)));
    };

    TypedArray.prototype.unshift = function() {
      return TypedArray.__super__.unshift.apply(this, typecast(arguments, this.type));
    };
